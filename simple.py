...
res = ALICE.alg_runner('ALICE-FAIL','CartPole-v1', verbose=2, total_opt_steps=50000, N_epoch=10, kill_feats=[3],
                       ...
                       opt_seed=seed, run_seed=seed, learning_rate=.01,recompute_adversary_freq=3,
                       density_ratio_feature_map='standardscaler poly-2',adversary_feature_map='standardscaler nys-1000',FORWARD=True)
